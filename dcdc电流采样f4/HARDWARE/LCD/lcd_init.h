...
#define LCD_CS_Clr()   GPIO_ResetBits(GPIOD,GPIO_Pin_13)//CS
#define LCD_CS_Set()   GPIO_SetBits(GPIOD,GPIO_Pin_13)

#define LCD_BLK_Clr()  GPIO_ResetBits(GPIOD,GPIO_Pin_15)//BLK
#define LCD_BLK_Set()  GPIO_SetBits(GPIOD,GPIO_Pin_15)
